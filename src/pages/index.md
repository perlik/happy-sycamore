...
sections:
  ...
  - type: section_features
    section_id: features
    title: Produkty
    subtitle: Wafle dobre! produkujemy z pełnowartościowych zbóż najlepszej jakości. Dzięki zastosowaniu unikalnej w skali światowej technologii pieczenia jesteśmy w stanie 
    background: gray
    features:
      - type: feature_item
